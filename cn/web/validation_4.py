...
model_dir='C:/tengk/wangm/dev/workspace_py/tfClassifier/image_classification/inception/ff'
...
def recognize(image='C:/Users/wm/Desktop/hh.jpg'):
    #读取图片
    ...
    for node_id in top_5:
        ...
        temp = '%s (score = %.5f)' % (human_string, score)
        result += temp + '\n'
    print(result)
    return result
